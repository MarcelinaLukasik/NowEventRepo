...
import { StandaloneSearchBox, GoogleMap, LoadScript, Marker, InfoWindow } from '@react-google-maps/api';
...
function Address(props) {
    ...
    async function handleLocationSave() {
        ...
        body: JSON.stringify({ FullAddress: address, Latitude: latitude, Longitude: longitude, 
            PlaceId: placeId, PlaceOpeningHours: String(openingHours), PlaceStatus: placeStatus, EventId: props.eventId}),
        })
