      ...
      <div className="event">  
        <div className="row">
            ...
            <form className="registerForm" method="post">     
                ...
                <div>
                    <textarea  className="messageInput" aria-required="true" 
                    placeholder="Message..." value={message} onChange={(event) => {setMessage(event.target.value)}}/>           
                </div>  
                <div className="form-floating">
                    <input  className="registerInput" autoComplete="username"
                     aria-required="true" placeholder="Email" value={email} onChange={(event) => {setEmail(event.target.value)}}/>                    
                </div> 
                <div>
                    <input  className="registerInput" aria-required="true" 
                    placeholder="Company name..." value={companyName} onChange={(event) => {setCompanyName(event.target.value)}}/>           
                </div>                                            
                <button id="registerSubmit" type="submit" className="registerButton" onClick={handlePost}>Submit</button>
                {/* {!valid &&
            ...
            {isCompleted &&   
            <div>        
            <div className="registerCompleted" >Request to prepare event submitted!</div> 
            <div className="registerMessage">Customer received your message.</div>  
            </div>        
            }
            </div>
            </div>
