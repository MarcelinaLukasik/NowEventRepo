            ...
            <TrackVisibility>
              {({ isVisible }) => (
                ...
                >
                  <h2>Features</h2>
                  <p>
                    Here are a bunch of features that will help you with
                    planning your party:
                  </p>
                  <Tab.Container id="features-tabs" defaultActiveKey="first">
                    ...
                    >
                      ...
                      <Tab.Pane eventKey="second">
                        <p>
                          After you complete your event settings you can post it
                          on our board and wait for contractors offers. It is
                          really that simple.
                        </p>
                      </Tab.Pane>
                      <Tab.Pane eventKey="third">
                        <p>
                          If you want to make your event look good, don't forget
                          to check out Inspiration section with ideas and cool
