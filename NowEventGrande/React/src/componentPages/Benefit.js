      ...
      <Container>
        ...
        <Row className="benefit">
          <Col cs={12} md={6} xl={7} className="benefit-header py-1">
            ...
            <h2>Time saving</h2>
            <p>
              NowEvent offers many features, but don't worry. Creating a new
              event is quick and uncomplicated.
            </p>
          </Col>
          <Col cs={12} md={6} xl={7} className="benefit-header py-1">
            <span>
            ...
            <h2>Comfortable</h2>
            <p>
              You can create your dream event without leaving home, and let
              someone else do all the job.
            </p>
          </Col>
          <Col cs={12} md={6} xl={7} className="benefit-header py-1">
            <span>
            ...
            <h2>Happiness</h2>
            <p>
              You can have fun without the stress of planning and organizing
              your event. Finally!
            </p>
          </Col>
